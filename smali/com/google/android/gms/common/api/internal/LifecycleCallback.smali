...
.method public static c(Landroid/app/Activity;)Lcom/google/android/gms/common/api/internal/LifecycleFragment;
    ...
    invoke-direct {v0, p0}, Lp6/e;-><init>(Landroid/app/Activity;)V

    invoke-static {v0}, Lcom/google/android/gms/common/api/internal/LifecycleCallback;->d(Lp6/e;)Lcom/google/android/gms/common/api/internal/LifecycleFragment;
...
.method protected static d(Lp6/e;)Lcom/google/android/gms/common/api/internal/LifecycleFragment;
    .locals 1
    .param p0    # Lp6/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0}, Lp6/e;->d()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lp6/e;->b()Landroidx/fragment/app/j;

    move-result-object p0

    invoke-static {p0}, Lp6/f0;->J1(Landroidx/fragment/app/j;)Lp6/f0;
    ...
    :cond_0
    invoke-virtual {p0}, Lp6/e;->c()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lp6/e;->a()Landroid/app/Activity;

    move-result-object p0

    invoke-static {p0}, Lp6/d0;->f(Landroid/app/Activity;)Lp6/d0;
...
.method private static getChimeraLifecycleFragmentImpl(Lp6/e;)Lcom/google/android/gms/common/api/internal/LifecycleFragment;
    .locals 1

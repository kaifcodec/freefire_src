...
.method static init(Lcom/google/firebase/FirebaseApp;Lcom/google/firebase/installations/FirebaseInstallationsApi;Lcom/google/firebase/inject/Deferred;Lcom/google/firebase/inject/Deferred;Lcom/google/firebase/inject/Deferred;)Lcom/google/firebase/crashlytics/FirebaseCrashlytics;
    ...
    invoke-virtual {v2, v3}, Lp8/f;->g(Ljava/lang/String;)V
    ...
    invoke-direct {v7, v1}, Lp8/c;-><init>(Lcom/google/firebase/inject/Deferred;)V

    new-instance v1, Lcom/google/firebase/crashlytics/d;

    move-object/from16 v4, p3

    invoke-direct {v1, v4}, Lcom/google/firebase/crashlytics/d;-><init>(Lcom/google/firebase/inject/Deferred;)V

    const-string v4, "Crashlytics Exception Handler"

    invoke-static {v4}, Lcom/google/firebase/crashlytics/internal/common/s;->c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {v13}, Ls9/a;->e(Ls9/b;)V
    ...
    invoke-virtual {v1}, Lcom/google/firebase/crashlytics/d;->e()Lcom/google/firebase/crashlytics/internal/breadcrumbs/BreadcrumbSource;

    move-result-object v9

    invoke-virtual {v1}, Lcom/google/firebase/crashlytics/d;->d()Lcom/google/firebase/crashlytics/internal/analytics/AnalyticsEventLogger;
    ...
    invoke-static {v0}, Lcom/google/firebase/crashlytics/internal/common/h;->m(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v0}, Lcom/google/firebase/crashlytics/internal/common/h;->j(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {v6, v2}, Lp8/f;->b(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v0}, Lp8/e;-><init>(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static/range {v1 .. v6}, Lcom/google/firebase/crashlytics/internal/common/AppData;->a(Landroid/content/Context;Lcom/google/firebase/crashlytics/internal/common/IdManager;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Lp8/e;)Lcom/google/firebase/crashlytics/internal/common/AppData;
    ...
    invoke-static {v1}, Lcom/google/firebase/crashlytics/internal/common/s;->c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static/range {v1 .. v8}, Ly8/f;->l(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/crashlytics/internal/common/IdManager;Lv8/b;Ljava/lang/String;Ljava/lang/String;Lcom/google/firebase/crashlytics/internal/persistence/FileStore;Lcom/google/firebase/crashlytics/internal/common/DataCollectionArbiter;)Ly8/f;

    move-result-object v0

    invoke-virtual {v0, v10}, Ly8/f;->o(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v3, v2, v1, v0}, Lcom/google/firebase/crashlytics/FirebaseCrashlytics$b;-><init>(ZLcom/google/firebase/crashlytics/internal/common/CrashlyticsCore;Ly8/f;)V

    invoke-static {v10, v3}, Lcom/google/android/gms/tasks/b;->c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v0, v2, v1}, Lp8/f;->e(Ljava/lang/String;Ljava/lang/Throwable;)V

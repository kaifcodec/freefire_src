...
# static fields
.field public static final b:Lqb/e$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqb/e;->b:Lqb/e$a;
    ...
    const-class v5, Lpb/p;

    aput-object v5, v0, v2

    const/4 v2, 0x6

    const-class v5, Lpb/q;

    aput-object v5, v0, v2

    const/4 v2, 0x7

    const-class v5, Lpb/r;

    aput-object v5, v0, v2

    const/16 v2, 0x8

    const-class v5, Lpb/s;

    aput-object v5, v0, v2

    const/16 v2, 0x9

    const-class v5, Lpb/t;
    ...
    const-class v6, Lpb/b;

    aput-object v6, v0, v2

    const/16 v2, 0xc

    const-class v6, Lpb/c;

    aput-object v6, v0, v2

    const/16 v2, 0xd

    const-class v6, Lpb/d;

    aput-object v6, v0, v2

    const/16 v2, 0xe

    const-class v6, Lpb/e;

    aput-object v6, v0, v2

    const/16 v2, 0xf

    const-class v6, Lpb/f;

    aput-object v6, v0, v2

    const/16 v2, 0x10

    const-class v6, Lpb/g;
    ...
    const-class v6, Lpb/i;

    aput-object v6, v0, v2

    const/16 v2, 0x13

    const-class v6, Lpb/j;

    aput-object v6, v0, v2

    const/16 v2, 0x14

    const-class v6, Lpb/k;

    aput-object v6, v0, v2

    const/16 v2, 0x15

    const-class v6, Lpb/l;

    aput-object v6, v0, v2

    const/16 v2, 0x16

    const-class v6, Lpb/m;
    ...
    :cond_1
    invoke-static {v2}, Lkotlin/collections/f0;->r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    sput-object v0, Lqb/e;->d:Ljava/util/HashMap;
    ...
    sput-object v2, Lqb/e;->e:Ljava/util/HashMap;
    ...
    invoke-static {v2, v5, v1, v4, v1}, Lkotlin/text/StringsKt;->j0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    sput-object v3, Lqb/e;->f:Ljava/util/HashMap;
    ...
    invoke-static {v2}, Lkotlin/collections/f0;->e(I)I
    ...
    invoke-static {v3, v5, v1, v4, v1}, Lkotlin/text/StringsKt;->j0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lqb/e;->a:Ljava/lang/Class;
...
.method public static final synthetic c()Ljava/util/Map;
    ...
    sget-object v0, Lqb/e;->g:Ljava/util/Map;
...
.method public a()Ljava/lang/String;
    ...
    sget-object v0, Lqb/e;->b:Lqb/e$a;

    invoke-virtual {p0}, Lqb/e;->b()Ljava/lang/Class;

    move-result-object v1

    invoke-virtual {v0, v1}, Lqb/e$a;->a(Ljava/lang/Class;)Ljava/lang/String;
...
.method public b()Ljava/lang/Class;
    ...
    iget-object v0, p0, Lqb/e;->a:Ljava/lang/Class;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lob/a;->b(Lvb/b;)Ljava/lang/Class;

    move-result-object v0

    check-cast p1, Lvb/b;

    invoke-static {p1}, Lob/a;->b(Lvb/b;)Ljava/lang/Class;

...
.field private final b:Landroidx/work/impl/q0;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/q0;)V
    .locals 0
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Landroidx/work/impl/q0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {p2}, Landroidx/work/impl/q0;->j()Ls1/s;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Ls1/s;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {v1}, Landroidx/work/impl/q0;->n()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/k;->i(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;)Z
    ...
    :try_start_0
    invoke-interface {v3}, Lr1/w;->k()Ljava/util/List;
    ...
    sget-object v9, Lm1/z$c;->a:Lm1/z$c;

    iget-object v10, v8, Lr1/v;->a:Ljava/lang/String;

    invoke-interface {v3, v9, v10}, Lr1/w;->r(Lm1/z$c;Ljava/lang/String;)I

    iget-object v9, v8, Lr1/v;->a:Ljava/lang/String;

    const/16 v10, -0x200

    invoke-interface {v3, v9, v10}, Lr1/w;->g(Ljava/lang/String;I)V

    iget-object v8, v8, Lr1/v;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v3, v8, v9, v10}, Lr1/w;->c(Ljava/lang/String;J)I

    goto :goto_2

    :cond_2
    invoke-interface {v4}, Lr1/s;->b()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {v0}, Landroidx/work/impl/q0;->q()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {v0}, Landroidx/work/impl/q0;->j()Ls1/s;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ls1/s;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Ls1/s;

    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {v1}, Landroidx/work/impl/q0;->g()Landroidx/work/a;
    ...
    invoke-virtual {v0, v1, v2}, Ls1/s;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/q0;

    invoke-virtual {v2}, Landroidx/work/impl/q0;->l()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, Ls1/f;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Ls1/s;

    invoke-virtual {v2}, Ls1/s;->a()J
    ...
    invoke-static {v6}, Ls1/g;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, Ls1/h;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, Lm1/n;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    invoke-static {v1, v0}, Ls1/t;->b(Landroid/content/Context;Landroidx/work/a;)Z
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/q0;->p()V
    ...
    invoke-static {v0}, Landroidx/work/impl/f0;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v3, v1, v0}, Lm1/n;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()Lz/a;
    ...
    invoke-virtual {v1, v3, v4, v2}, Lm1/n;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, Lm1/n;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, Lm1/n;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/q0;->p()V

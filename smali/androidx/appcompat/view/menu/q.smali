...
.field final i:Landroidx/appcompat/widget/k2;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroidx/appcompat/widget/k2;

    const/4 p6, 0x0

    invoke-direct {p3, p1, p6, p4, p5}, Landroidx/appcompat/widget/k2;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;
...
.method private z()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/d2;->z(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;

    iget v3, p0, Landroidx/appcompat/view/menu/q;->t:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/d2;->C(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/d2;->B(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/d2;->E(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/d2;->D(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/d2;->j()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/d2;->p(Landroid/widget/ListAdapter;)V
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;

    invoke-virtual {v2}, Landroidx/appcompat/widget/d2;->b()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/k2;

    invoke-virtual {v3}, Landroidx/appcompat/widget/d2;->o()I
    ...
    invoke-static {v5}, Landroidx/core/view/c1;->p(Landroid/view/View;)I
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/d2;->d(I)V
...
.method public w(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/d2;->l(I)V

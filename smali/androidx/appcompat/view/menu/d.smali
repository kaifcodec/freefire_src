...
.field private final l:Landroidx/appcompat/widget/h2;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/h2;
...
.method private F(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->z()Landroidx/appcompat/widget/k2;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/d2;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/d2;->B(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/d2;->C(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/k2;->Q(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/k2;->N(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/d2;->z(Landroid/view/View;)V
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/d2;->d(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/d2;->I(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/d2;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/d2;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/d2;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/d2;->D(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/k2;Landroidx/appcompat/view/menu/g;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->i:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/d2;->h()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/d2;->j()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/k2;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/k2;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/h2;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/k2;->P(Landroidx/appcompat/widget/h2;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/d2;->H(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/d2;->G(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/d2;->z(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/d2;->C(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/d2;->F(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/d2;->E(I)V
...
.method public a()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v0}, Landroidx/appcompat/widget/d2;->a()Z
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/k2;->O(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/d2;->A(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v0}, Landroidx/appcompat/widget/d2;->dismiss()V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v3}, Landroidx/appcompat/widget/d2;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v2}, Landroidx/appcompat/widget/d2;->dismiss()V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/k2;

    invoke-virtual {v4}, Landroidx/appcompat/widget/d2;->a()Z
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/c1;->p(Landroid/view/View;)I

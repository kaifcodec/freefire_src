...
.method private i(Landroid/view/MenuItem;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/o0;->a(Landroid/view/MenuItem;Landroidx/core/view/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Landroidx/appcompat/view/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroidx/core/view/o0;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroidx/appcompat/view/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroidx/core/view/o0;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Landroidx/appcompat/view/g$b;->n:C

    iget v1, p0, Landroidx/appcompat/view/g$b;->o:I

    invoke-static {p1, v0, v1}, Landroidx/core/view/o0;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Landroidx/appcompat/view/g$b;->p:C

    iget v1, p0, Landroidx/appcompat/view/g$b;->q:I

    invoke-static {p1, v0, v1}, Landroidx/core/view/o0;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Landroidx/appcompat/view/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Landroidx/core/view/o0;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/o0;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lk/j;->v1:[I

    invoke-static {v0, p1, v1}, Landroidx/appcompat/widget/x2;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/x2;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/x2;->m(II)I
    ...
    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/x2;->j(II)I
    ...
    invoke-virtual {p1, v2, v3}, Landroidx/appcompat/widget/x2;->j(II)I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/x2;->o(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/x2;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/x2;->r(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/x2;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/x2;->a(IZ)Z
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/x2;->c(I)Landroid/content/res/ColorStateList;

...
.field private static final h:Lt/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lt/g<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/s;->h:Lt/g;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/c1;->M(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/c1;->N(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, p3}, Landroidx/core/view/c1;->U(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/c1;->w(Landroid/view/View;)Z
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/s;->h:Lt/g;

    invoke-virtual {v0, p2}, Lt/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v1}, Lt/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m0;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method protected l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n0;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method protected m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q0;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method protected n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s0;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v0, p1, p2}, Landroidx/appcompat/widget/s0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g1;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v0, p1, p2}, Landroidx/appcompat/widget/g1;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v1;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v1;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m0;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s0;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q0;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g1;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n0;

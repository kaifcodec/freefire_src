...
# interfaces
.implements Landroidx/appcompat/widget/m2$f;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/s2;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Lk/a;->u:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/s2;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/s2;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/s2;->e:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/s2;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/s2;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/s2;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/s2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/s2;->b:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/s2;->f:[I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/s2;->b(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v6

    sget-object v3, Landroidx/appcompat/widget/s2;->f:[I

    aput-object v3, v1, v5

    sget v3, Lk/a;->v:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/s2;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/s2;->i:[I
...
.method private l(Landroidx/appcompat/widget/m2;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    .param p1    # Landroidx/appcompat/widget/m2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/m2;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Lk/e;->G:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/m2;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/y1;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/y1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, p2}, Landroidx/appcompat/widget/s2;->c(Landroid/content/Context;I)I
...
.method public c(Landroidx/appcompat/widget/m2;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    .param p1    # Landroidx/appcompat/widget/m2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/k$a;->l(Landroidx/appcompat/widget/m2;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Ll/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/s2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/s2;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/s2;->b(Landroid/content/Context;I)I

...
.method private a(Landroid/content/Context;Ly/g;)Landroidx/emoji2/text/e$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/j;-><init>(Landroid/content/Context;Ly/g;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Ly/g;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, Ly/g;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/e$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/c$a;->h(Landroid/content/Context;)Ly/g;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/c$a;->a(Landroid/content/Context;Ly/g;)Landroidx/emoji2/text/e$c;
...
.method h(Landroid/content/Context;)Ly/g;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/c$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Ly/g;

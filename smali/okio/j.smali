...
.method private b()V
    ...
    iget-object v0, v6, Lokio/j;->b:Lokio/e;

    const-wide/16 v1, 0xa

    invoke-interface {v0, v1, v2}, Lokio/e;->Q0(J)V

    iget-object v0, v6, Lokio/j;->b:Lokio/e;

    invoke-interface {v0}, Lokio/e;->j()Lokio/c;

    move-result-object v0

    const-wide/16 v1, 0x3

    invoke-virtual {v0, v1, v2}, Lokio/c;->B(J)B
    ...
    invoke-direct/range {v0 .. v5}, Lokio/j;->d(Lokio/c;JJ)V
    ...
    invoke-direct {v6, v1, v2, v0}, Lokio/j;->a(Ljava/lang/String;II)V
    ...
    iget-object v1, v6, Lokio/j;->b:Lokio/e;

    int-to-long v11, v0

    invoke-interface {v1, v11, v12}, Lokio/e;->Q0(J)V
    ...
    invoke-interface {v0, v9}, Lokio/e;->W0(B)J
    ...
    invoke-interface {v0}, Lokio/e;->I0()S
    ...
    invoke-direct {v6, v2, v0, v1}, Lokio/j;->a(Ljava/lang/String;II)V
...
.method private c()V
    ...
    invoke-interface {v0}, Lokio/e;->x0()I
    ...
    invoke-direct {p0, v1, v0, v2}, Lokio/j;->a(Ljava/lang/String;II)V
...
.method public K0(Lokio/c;J)J
    ...
    invoke-virtual {v0, p1, p2, p3}, Lokio/k;->K0(Lokio/c;J)J
    ...
    invoke-direct/range {v5 .. v10}, Lokio/j;->d(Lokio/c;JJ)V

    return-wide p2

    :cond_2
    iput v4, p0, Lokio/j;->a:I

    :cond_3
    iget p1, p0, Lokio/j;->a:I
    ...
    iput p1, p0, Lokio/j;->a:I

    iget-object p1, p0, Lokio/j;->b:Lokio/e;

    invoke-interface {p1}, Lokio/e;->M()Z
